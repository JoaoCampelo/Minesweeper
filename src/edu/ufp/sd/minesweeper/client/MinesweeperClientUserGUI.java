...
public class MinesweeperClientUserGUI extends javax.swing.JFrame implements ActionListener, WindowListener {

    private MinesweeperClientImpl msClient;

    /**
     * Creates new form MinesweeperClientLoginUI
     */
    public MinesweeperClientUserGUI(MinesweeperClientImpl msClient) {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if (login) {
            msClient.triggeredLogin(jtfUsername.getText(), String.valueOf(jtfPassword.getPassword()));
        }
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        ...
        if (register) {
            msClient.triggeredRegister(jtfUsername.getText(), String.valueOf(jtfPassword.getPassword()));
        }
    ...
    public void updateClients() {
        State.ConnectedClients sc = (State.ConnectedClients) this.msClient.getLastState();
    }
    ...
    public void windowClosing(WindowEvent e) {
        msClient.triggeredLogout(jtfUsername.getText(), String.valueOf(jtfPassword.getPassword()));
    }
