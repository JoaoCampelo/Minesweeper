...
public class MinesweeperServerGUI extends javax.swing.JFrame implements WindowListener {

    private MinesweeperServerImpl msServer;
    ...
    /**
     * Creates new form MinesweeperServerGUI
     */
    public MinesweeperServerGUI(MinesweeperServerImpl msServer) {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addComponent(jTabbedPane, javax.swing.GroupLayout.PREFERRED_SIZE, 303, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    protected void addConnectedClient(String username, int value) {
        ...
        try {
            this.msServer.setState(new State().new ConnectedClients(value));
        } catch (RemoteException ex) {
            Logger.getLogger(MinesweeperServerGUI.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    protected void addRoomToList(String name) {
        ...
        this.lblLobbysValue.setText(String.valueOf(this.roomsList.size()));
    }
    ...
    public void windowClosing(WindowEvent e) {
        try {
            try {
                this.msServer.setState(new State().new Disconnect(0, "Server is closing..."));
            } catch (RemoteException ex) {
                Logger.getLogger(MinesweeperServerGUI.class.getName()).log(Level.SEVERE, null, ex);
            }
            Thread.sleep(50);
